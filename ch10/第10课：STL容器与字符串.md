...
```
(base) ubuntu@ubuntu-System-Product-Name:~/stephen/01-code/cpp4ai/ch10/code$ g++ -O3 vocab_benchmark.cpp -o vocab_benchmark
./vocab_benchmark
--- Token-to-ID Vocabulary Benchmark ---
Building vocabulary with 100000 tokens...

[std::map] Time for 50000 queries: 4.67469 ms
[std::unordered_map] Time for 50000 queries: 0.991749 ms
